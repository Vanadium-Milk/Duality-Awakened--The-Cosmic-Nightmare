...
draw_text_color(display_get_gui_width() - 2,76,display_text,color,color,color,color,1);
draw_text_color(display_get_gui_width() - 4,3, "FPS: " + string(fps),color,color,color,color,1);