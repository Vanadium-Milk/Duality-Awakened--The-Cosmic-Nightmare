...
part_type_speed(_ptype1, objPlayer.guns[objPlayer.weapon.index].bullet_speed, objPlayer.guns[objPlayer.weapon.index].bullet_speed, 0, 0);
//Tried to set angle on direction but it's not possible since the trail is created at the same time the bullet is
part_type_direction(_ptype1, objPlayer.weapon.angle + 180, objPlayer.weapon.angle + 180, 0, 0);
...
part_emitter_region(_ps, _pemit1, -4.5, 4.5, -2.5, 2.5, ps_shape_ellipse, ps_distr_linear);
